...
Scenario: add movie
  ...
  When I fill in "Title" with "The Inception"
  And I select "R" from "Rating"
  And I press "Save Changes"
  Then I should be on the RottenPotatoes home page
  And I should see "The Inception was successfully created."
...
#Scenario: sort movies in increasing order of release date(index)
  Given I am on the RottenPotatoes home page
